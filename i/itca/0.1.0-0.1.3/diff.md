# Comparing `tmp/itca-0.1.0.tar.gz` & `tmp/itca-0.1.3.tar.gz`
...
## Comparing `itca-0.1.0.tar` & `itca-0.1.3.tar`
...
### Comparing `itca-0.1.0/itca/search.py` & `itca-0.1.3/itca/search.py`
...
### Comparing `itca-0.1.0/setup.py` & `itca-0.1.3/setup.py`
