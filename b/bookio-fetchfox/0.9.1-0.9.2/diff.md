# Comparing `tmp/bookio_fetchfox-0.9.1.tar.gz` & `tmp/bookio_fetchfox-0.9.2.tar.gz`
...
### Comparing `bookio_fetchfox-0.9.1/fetchfox/dtos/sale.py` & `bookio_fetchfox-0.9.2/fetchfox/dtos/sale.py`
