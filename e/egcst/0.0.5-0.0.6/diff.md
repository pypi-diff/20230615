# Comparing `tmp/egcst-0.0.5.tar.gz` & `tmp/egcst-0.0.6.tar.gz`
...
## Comparing `egcst-0.0.5.tar` & `egcst-0.0.6.tar`
...
### Comparing `egcst-0.0.5/README.md` & `egcst-0.0.6/README.md`

 * *Files identical despite different names*

### Comparing `egcst-0.0.5/egcst/core.py` & `egcst-0.0.6/egcst/core.py`
...
### Comparing `egcst-0.0.5/setup.py` & `egcst-0.0.6/setup.py`
