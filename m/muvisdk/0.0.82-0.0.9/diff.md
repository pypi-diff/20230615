# Comparing `tmp/muvisdk-0.0.82.tar.gz` & `tmp/muvisdk-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "muvisdk-0.0.82.tar", last modified: Thu Jun 15 14:53:36 2023, max compression
+gzip compressed data, was "muvisdk-0.0.9.tar", last modified: Mon Aug  8 13:00:37 2022, max compression
```

## Comparing `muvisdk-0.0.82.tar` & `muvisdk-0.0.9.tar`

### file list

```diff
@@ -1,35 +1,30 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/
--rw-r--r--   0 runner    (1001) docker     (123)      290 2023-06-15 14:53:36.904072 muvisdk-0.0.82/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      102 2023-06-15 14:53:25.000000 muvisdk-0.0.82/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-15 14:53:36.904072 muvisdk-0.0.82/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      830 2023-06-15 14:53:25.000000 muvisdk-0.0.82/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.900072 muvisdk-0.0.82/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/src/muvisdk/
--rw-r--r--   0 runner    (1001) docker     (123)      676 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/MuviBase.py
--rw-r--r--   0 runner    (1001) docker     (123)     1478 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/SDK.py
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/src/muvisdk/decidir_sdk/
--rw-r--r--   0 runner    (1001) docker     (123)     3503 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/Card.py
--rw-r--r--   0 runner    (1001) docker     (123)     1159 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/CardToken.py
--rw-r--r--   0 runner    (1001) docker     (123)     2389 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/Customer.py
--rw-r--r--   0 runner    (1001) docker     (123)     2521 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/DecidirSDK.py
--rw-r--r--   0 runner    (1001) docker     (123)     9459 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/Payment.py
--rw-r--r--   0 runner    (1001) docker     (123)     2007 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/Refund.py
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/decidir_sdk/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/
--rw-r--r--   0 runner    (1001) docker     (123)     1912 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Card.py
--rw-r--r--   0 runner    (1001) docker     (123)     1303 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/CardToken.py
--rw-r--r--   0 runner    (1001) docker     (123)     3203 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Customer.py
--rw-r--r--   0 runner    (1001) docker     (123)     1952 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/MercadoPagoSDK.py
--rw-r--r--   0 runner    (1001) docker     (123)     4882 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Payment.py
--rw-r--r--   0 runner    (1001) docker     (123)      659 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Refund.py
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:25.000000 muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/src/muvisdk.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      290 2023-06-15 14:53:36.000000 muvisdk-0.0.82/src/muvisdk.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      831 2023-06-15 14:53:36.000000 muvisdk-0.0.82/src/muvisdk.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-15 14:53:36.000000 muvisdk-0.0.82/src/muvisdk.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       25 2023-06-15 14:53:36.000000 muvisdk-0.0.82/src/muvisdk.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        8 2023-06-15 14:53:36.000000 muvisdk-0.0.82/src/muvisdk.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-15 14:53:36.904072 muvisdk-0.0.82/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     1708 2023-06-15 14:53:25.000000 muvisdk-0.0.82/tests/test_cards.py
--rw-r--r--   0 runner    (1001) docker     (123)     2335 2023-06-15 14:53:25.000000 muvisdk-0.0.82/tests/test_customers.py
...
### Comparing `muvisdk-0.0.82/setup.py` & `muvisdk-0.0.9/setup.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk/decidir_sdk/Card.py` & `muvisdk-0.0.9/src/muvisdk/decidir_sdk/Card.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk/decidir_sdk/CardToken.py` & `muvisdk-0.0.9/src/muvisdk/decidir_sdk/CardToken.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk/decidir_sdk/Customer.py` & `muvisdk-0.0.9/src/muvisdk/decidir_sdk/Customer.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Card.py` & `muvisdk-0.0.9/src/muvisdk/mercadopago_sdk/Card.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk/mercadopago_sdk/Customer.py` & `muvisdk-0.0.9/src/muvisdk/mercadopago_sdk/Customer.py`
...
### Comparing `muvisdk-0.0.82/src/muvisdk.egg-info/SOURCES.txt` & `muvisdk-0.0.9/src/muvisdk.egg-info/SOURCES.txt`
