# Comparing `tmp/democracy-1.0.25.tar.gz` & `tmp/democracy-1.0.27.tar.gz`
...
## Comparing `democracy-1.0.25.tar` & `democracy-1.0.27.tar`
...
### Comparing `democracy-1.0.25/PKG-INFO` & `democracy-1.0.27/PKG-INFO`
...
### Comparing `democracy-1.0.25/README.md` & `democracy-1.0.27/README.md`

 * *Files identical despite different names*

### Comparing `democracy-1.0.25/democracy.egg-info/PKG-INFO` & `democracy-1.0.27/democracy.egg-info/PKG-INFO`
...
### Comparing `democracy-1.0.25/pyproject.toml` & `democracy-1.0.27/pyproject.toml`
