# Comparing `tmp/th2_grpc_lw_data_provider-2.0.0.dev5275644455.tar.gz` & `tmp/th2_grpc_lw_data_provider-2.1.0.dev3871883101.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/th2_grpc_lw_data_provider-2.0.0.dev5275644455.tar", last modified: Thu Jun 15 06:45:56 2023, max compression
...
## Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455.tar` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101.tar`

### file list

```diff
@@ -1,25 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/
--rw-r--r--   0 runner    (1001) docker     (122)      378 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)       27 2023-06-15 06:44:01.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/README.md
--rw-r--r--   0 runner    (1001) docker     (122)       93 2023-06-15 06:44:01.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/package_info.json
--rw-r--r--   0 runner    (1001) docker     (122)       38 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (122)     4495 2023-06-15 06:44:01.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/
--rw-r--r--   0 runner    (1001) docker     (122)        0 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/__init__.py
--rw-r--r--   0 runner    (1001) docker     (122)     1505 2023-06-15 06:45:27.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/data_provider_service.py
--rw-r--r--   0 runner    (1001) docker     (122)     7981 2023-06-15 06:44:01.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider.proto
--rw-r--r--   0 runner    (1001) docker     (122)    10795 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2.py
--rw-r--r--   0 runner    (1001) docker     (122)    30120 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi
--rw-r--r--   0 runner    (1001) docker     (122)    15651 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py
--rw-r--r--   0 runner    (1001) docker     (122)        0 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/py.typed
--rw-r--r--   0 runner    (1001) docker     (122)     2242 2023-06-15 06:44:01.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider.proto
--rw-r--r--   0 runner    (1001) docker     (122)     4891 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2.py
--rw-r--r--   0 runner    (1001) docker     (122)    10186 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi
--rw-r--r--   0 runner    (1001) docker     (122)     5036 2023-06-15 06:45:55.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py
--rw-r--r--   0 runner    (1001) docker     (122)      571 2023-06-15 06:45:27.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_service.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)      378 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      883 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)       22 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)       27 2023-06-15 06:45:56.000000 th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/top_level.txt
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/setup.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/setup.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/data_provider_service.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/data_provider_service.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider.proto` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider.proto`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider.proto` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider.proto`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider/queue_data_provider_service.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_service.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev5275644455/th2_grpc_lw_data_provider.egg-info/SOURCES.txt` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider.egg-info/SOURCES.txt`
