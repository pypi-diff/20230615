# Comparing `tmp/resimpyx-0.0.0.4.tar.gz` & `tmp/resimpyx-0.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "resimpyx-0.0.0.4.tar", last modified: Thu Jun 15 12:08:53 2023, max compression
+gzip compressed data, was "dist\resimpyx-0.0.1.tar", last modified: Wed Jan  5 02:00:41 2022, max compression
```

## Comparing `resimpyx-0.0.0.4.tar` & `resimpyx-0.0.1.tar`

### file list

```diff
@@ -1,13 +1,126 @@
-drwxrwxrwx   0        0        0        0 2023-06-15 12:08:53.907939 resimpyx-0.0.0.4/
--rw-rw-rw-   0        0        0     1089 2021-07-19 17:27:05.000000 resimpyx-0.0.0.4/LICENSE
--rw-rw-rw-   0        0        0      372 2023-06-15 12:08:53.904935 resimpyx-0.0.0.4/PKG-INFO
--rw-rw-rw-   0        0        0     7565 2022-01-05 22:42:22.000000 resimpyx-0.0.0.4/README.md
-drwxrwxrwx   0        0        0        0 2023-06-15 12:08:53.900935 resimpyx-0.0.0.4/resimpyx.egg-info/
--rw-rw-rw-   0        0        0      372 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      220 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      222 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0       70 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/requires.txt
--rw-rw-rw-   0        0        0        1 2023-06-15 12:08:53.000000 resimpyx-0.0.0.4/resimpyx.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-06-15 12:08:53.907939 resimpyx-0.0.0.4/setup.cfg
--rw-rw-rw-   0        0        0     1136 2023-06-15 12:08:47.000000 resimpyx-0.0.0.4/setup.py
...
### Comparing `resimpyx-0.0.0.4/setup.py` & `resimpyx-0.0.1/setup.py`
