# Comparing `tmp/Cashooo-1.1.0.tar.gz` & `tmp/Cashooo-1.1.1.tar.gz`
...
## Comparing `Cashooo-1.1.0.tar` & `Cashooo-1.1.1.tar`
...
### Comparing `Cashooo-1.1.0/Cashooo/mylibrary/custom_error.py` & `Cashooo-1.1.1/Cashooo/mylibrary/custom_error.py`

 * *Files identical despite different names*

### Comparing `Cashooo-1.1.0/Cashooo/mylibrary/middleware.py` & `Cashooo-1.1.1/Cashooo/mylibrary/middleware.py`
