# Comparing `tmp/Simba-UW-tf-dev-1.63.0.tar.gz` & `tmp/Simba-UW-tf-dev-1.63.1.tar.gz`
...
### Comparing `Simba-UW-tf-dev-1.63.0/PKG-INFO` & `Simba-UW-tf-dev-1.63.1/PKG-INFO`
...
### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/ui/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/movement_analysis_time_bins_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/movement_analysis_time_bins_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/csv_2_parquet_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/csv_2_parquet_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/quick_path_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/quick_path_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/batch_preprocess_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/batch_preprocess_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/heatmap_location_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/heatmap_location_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_probability_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_probability_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/movement_analysis_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/movement_analysis_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/set_machine_model_parameters_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/set_machine_model_parameters_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/path_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/path_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/remove_roi_features_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/remove_roi_features_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/smoothing_interpolation_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/smoothing_interpolation_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/roi_analysis_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/roi_analysis_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/outlier_settings_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/outlier_settings_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/gantt_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/gantt_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_validation_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_validation_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/severity_analysis_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/severity_analysis_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/fsttc_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/fsttc_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/kleinberg_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/kleinberg_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/directing_other_animals_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/directing_other_animals_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/pose_reorganizer_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/pose_reorganizer_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/append_roi_features_animals_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/append_roi_features_animals_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_by_timebins_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_by_timebins_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/heatmap_clf_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/heatmap_clf_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/data_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/data_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/roi_features_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/roi_features_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/pup_retrieval_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/pup_retrieval_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/about_simba_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/about_simba_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_descriptive_statistics_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_descriptive_statistics_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/roi_tracking_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/roi_tracking_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/append_roi_features_bodypart_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/append_roi_features_bodypart_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_add_remove_print_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_add_remove_print_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/video_processing_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/video_processing_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/validation_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/validation_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/clf_by_roi_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/clf_by_roi_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/make_path_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/make_path_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/create_user_defined_pose_configuration_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/create_user_defined_pose_configuration_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/archive_files_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/archive_files_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/pose_bp_drop_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/pose_bp_drop_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/distance_plot_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/distance_plot_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/subset_feature_extractor_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/subset_feature_extractor_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/third_party_annotator_appender_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/third_party_annotator_appender_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/pop_ups/roi_analysis_time_bins_pop_up.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/pop_ups/roi_analysis_time_bins_pop_up.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/video_info_ui.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/video_info_ui.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/user_defined_pose_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/user_defined_pose_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/create_project_ui.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/create_project_ui.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/tkinter_functions.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/tkinter_functions.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/ui/machine_model_settings_ui.py` & `Simba-UW-tf-dev-1.63.1/simba/ui/machine_model_settings_ui.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/blob_storage/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/blob_storage/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/labelling/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/labelling/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/labelling/labelling_interface.py` & `Simba-UW-tf-dev-1.63.1/simba/labelling/labelling_interface.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/labelling/extract_labelled_frames.py` & `Simba-UW-tf-dev-1.63.1/simba/labelling/extract_labelled_frames.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/labelling/labelling_advanced_interface.py` & `Simba-UW-tf-dev-1.63.1/simba/labelling/labelling_advanced_interface.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/labelling/play_annotation_video.py` & `Simba-UW-tf-dev-1.63.1/simba/labelling/play_annotation_video.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/dbcv_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/dbcv_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/enums.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/enums.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/dataset_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/dataset_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/grid_search_visualizers.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/grid_search_visualizers.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/data_extractor.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/data_extractor.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/ui.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/ui.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/umap_embedder.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/umap_embedder.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/pop_up_classes.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/pop_up_classes.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/bout_aggregator.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/bout_aggregator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/cluster_statistics.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/cluster_statistics.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/data_map.yaml` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/data_map.yaml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/hdbscan_clusterer.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/hdbscan_clusterer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/tsne.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/tsne.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/unsupervised/cluster_visualizer.py` & `Simba-UW-tf-dev-1.63.1/simba/unsupervised/cluster_visualizer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/agg_boundary_stats.py` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/agg_boundary_stats.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/boundary_menus.py` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/boundary_menus.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/boundary_statistics.py` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/boundary_statistics.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/find_boundaries.py` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/find_boundaries.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/bounding_box_tools/visualize_boundaries.py` & `Simba-UW-tf-dev-1.63.1/simba/bounding_box_tools/visualize_boundaries.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_14bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_14bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_7bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_7bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/doctests.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/doctests.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/fish_feature_extractor_2023_version_3.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/fish_feature_extractor_2023_version_3.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/read_in_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/read_in_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/peaks.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/peaks.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/fish_feature_extractor_2022.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/fish_feature_extractor_2022.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/convex_hull_3_scratch_3.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/convex_hull_3_scratch_3.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/convex_hull_scratch_1.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/convex_hull_scratch_1.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/fish_feature_extractor_2023_version_2.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/fish_feature_extractor_2023_version_2.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/egocentrical_aligner.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/egocentrical_aligner.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/count_values_in_range.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/count_values_in_range.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/graph_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/graph_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/termite_rois.csv` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/termite_rois.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/mutual_exclusive.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/mutual_exclusive.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/video_color.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/video_color.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/graph_3d_plotter.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/graph_3d_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/shap_log_mp_2.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/shap_log_mp_2.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/video_rotator.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/video_rotator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/shap_log_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/shap_log_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/add_probability_cnt_features.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/add_probability_cnt_features.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/make_splash.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/make_splash.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/fish_feature_extractor_2023_version_5.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/fish_feature_extractor_2023_version_5.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/time_stamp_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/time_stamp_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/video_rotator_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/video_rotator_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/read_files_mp_2.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/read_files_mp_2.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/fish_feature_extractor_2023_version_4.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/fish_feature_extractor_2023_version_4.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/misc/convex_hull_scratch_2.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/misc/convex_hull_scratch_2.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_8bps_2_animals.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_8bps_2_animals.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/perimeter_jit.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/perimeter_jit.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_subsets.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_subsets.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_user_defined.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_user_defined.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_16bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_16bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_9bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_9bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_8bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_8bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/feature_extractor_4bp.py` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/feature_extractor_4bp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/.idea/features_scripts.iml` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/.idea/features_scripts.iml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/.idea/inspectionProfiles/Project_Default.xml` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/.idea/inspectionProfiles/Project_Default.xml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/feature_extractors/.idea/workspace.xml` & `Simba-UW-tf-dev-1.63.1/simba/feature_extractors/.idea/workspace.xml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/requirements.txt` & `Simba-UW-tf-dev-1.63.1/simba/requirements.txt`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/mixins/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/pop_up_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/pop_up_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/config_reader.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/config_reader.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/pose_importer_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/pose_importer_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-334.py36m.nbi` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-334.py36m.nbi`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-333.py36m.nbi` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-333.py36m.nbi`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.nbi` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.nbi`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-334.py36m.1.nbc` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-334.py36m.1.nbc`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-333.py36m.1.nbc` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.cdist-333.py36m.1.nbc`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.2.nbc` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.2.nbc`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.1.nbc` & `Simba-UW-tf-dev-1.63.1/simba/mixins/__pycache__/feature_extraction_mixin.FeatureExtractionMixin.angle3pt-84.py36m.1.nbc`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/feature_extraction_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/feature_extraction_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/plotting_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/plotting_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/unsupervised_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/unsupervised_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/mixins/train_model_mixin.py` & `Simba-UW-tf-dev-1.63.1/simba/mixins/train_model_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/deepethogram_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/deepethogram_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/BORIS_appender.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/BORIS_appender.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/observer_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/observer_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/tools.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/tools.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/third_party_appender.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/third_party_appender.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/ethovision_import.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/ethovision_import.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/BENTO_appender.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/BENTO_appender.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/third_party_label_appenders/solomon_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/third_party_label_appenders/solomon_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_clf_statistics.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_clf_statistics.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_analyzer.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_analyzer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_menues.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_menues.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_tools.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_tools.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_visualizer.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_visualizer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/cue_light_tools/cue_light_movement_statistics.py` & `Simba-UW-tf-dev-1.63.1/simba/cue_light_tools/cue_light_movement_statistics.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/config_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/config_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/enums.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/enums.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/utils/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/warnings.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/warnings.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/checks.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/checks.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/read_write.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/read_write.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/lookups.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/lookups.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/cli/cli_tools.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/cli/cli_tools.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/errors.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/errors.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/data.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/data.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/utils/printing.py` & `Simba-UW-tf-dev-1.63.1/simba/utils/printing.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_processors/reorganize_keypoint.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_processors/reorganize_keypoint.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_processors/remove_keypoints.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_processors/remove_keypoints.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_processors/pose_reset.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_processors/pose_reset.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_processors/reverse_pose.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_processors/reverse_pose.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/gantt_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/gantt_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/tools/tkinter_tools.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/tools/tkinter_tools.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/ROI_plotter_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/ROI_plotter_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/plotting/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/shap_agg_stats_visualizer.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/shap_agg_stats_visualizer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/gantt_creator_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/gantt_creator_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/heat_mapper_clf_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/heat_mapper_clf_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/probability_plot_creator.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/probability_plot_creator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/plot_clf_results.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/plot_clf_results.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/plot_clf_results_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/plot_clf_results_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/ROI_feature_visualizer.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/ROI_feature_visualizer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/heat_mapper_location.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/heat_mapper_location.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/probability_plot_creator_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/probability_plot_creator_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/interactive_probability_grapher.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/interactive_probability_grapher.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/plot_pose_in_dir.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/plot_pose_in_dir.py`
...
### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/single_run_model_validation_video.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/single_run_model_validation_video.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/frame_mergerer_ffmpeg.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/frame_mergerer_ffmpeg.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/Directing_animals_visualizer_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/Directing_animals_visualizer_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/clf_validator.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/clf_validator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/path_plotter_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/path_plotter_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/ROI_feature_visualizer_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/ROI_feature_visualizer_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/data_plotter.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/data_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/path_plotter.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/path_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/ez_lineplot.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/ez_lineplot.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/distance_plotter_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/distance_plotter_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/ROI_plotter.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/ROI_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/heat_mapper_clf.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/heat_mapper_clf.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/distance_plotter.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/distance_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/single_run_model_validation_video_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/single_run_model_validation_video_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/Directing_animals_visualizer.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/Directing_animals_visualizer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/plotting/heat_mapper_location_mp.py` & `Simba-UW-tf-dev-1.63.1/simba/plotting/heat_mapper_location_mp.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/dash_app/SimBA_dash_app.py` & `Simba-UW-tf-dev-1.63.1/simba/dash_app/SimBA_dash_app.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/dash_app/run_dash_tkinter.py` & `Simba-UW-tf-dev-1.63.1/simba/dash_app/run_dash_tkinter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/dash_app/dash_app.py` & `Simba-UW-tf-dev-1.63.1/simba/dash_app/dash_app.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/agg_clf_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/agg_clf_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/severity_bout_based_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/severity_bout_based_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/interpolation_smoothing.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/interpolation_smoothing.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/timebins_clf_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/timebins_clf_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/fsttc_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/fsttc_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/interpolate_pose.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/interpolate_pose.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/directing_other_animals_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/directing_other_animals_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/timebins_movement_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/timebins_movement_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/severity_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/severity_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/pup_retrieval_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/pup_retrieval_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/pybursts_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/pybursts_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/severity_frame_based_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/severity_frame_based_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/kleinberg_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/kleinberg_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/data_processors/movement_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/data_processors/movement_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/bp_names/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/bp_names/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/bp_names/bp_names.csv` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/bp_names/bp_names.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/no_animals/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/no_animals/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/configuration_names/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/configuration_names/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/8.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/8.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/9.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/9.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/12.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/12.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/13.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/13.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/11.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/11.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/10.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/10.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/4.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/4.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/5.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/5.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/7.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/7.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/6.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/6.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/2.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/2.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/3.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/3.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/1.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations_archive/pose_configurations_archive_1/schematics/1.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/model/train_rf.py` & `Simba-UW-tf-dev-1.63.1/simba/model/train_rf.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/model/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/model/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/model/inference_batch.py` & `Simba-UW-tf-dev-1.63.1/simba/model/inference_batch.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/model/grid_search_rf.py` & `Simba-UW-tf-dev-1.63.1/simba/model/grid_search_rf.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/model/inference_validation.py` & `Simba-UW-tf-dev-1.63.1/simba/model/inference_validation.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_time_bin_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_time_bin_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_movement_analyzer.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_movement_analyzer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_define.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_define.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_reset.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_reset.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_analyzer.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_analyzer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_feature_analyzer.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_feature_analyzer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_multiply.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_multiply.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_size_calculations.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_size_calculations.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_zoom.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_zoom.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_directing_analyzer.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_directing_analyzer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_move_shape.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_move_shape.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_menus.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_menus.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_clf_calculator.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_clf_calculator.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/roi_tools/ROI_image.py` & `Simba-UW-tf-dev-1.63.1/simba/roi_tools/ROI_image.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/sleap_csv_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/sleap_csv_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/misc/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/misc/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/misc/apt_trk_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/misc/apt_trk_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/read_DANNCE_mat.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/read_DANNCE_mat.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/sleap_h5_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/sleap_h5_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/madlc_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/madlc_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/sleap_slp_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/sleap_slp_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/import_mars.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/import_mars.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/dlc_importer_csv.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/dlc_importer_csv.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_importers/trk_importer.py` & `Simba-UW-tf-dev-1.63.1/simba/pose_importers/trk_importer.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/bp_names/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/bp_names/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/bp_names/bp_names.csv` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/bp_names/bp_names.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/no_animals/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/no_animals/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/configuration_names/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/configuration_names/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/8.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/8.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/9.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/9.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/12.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/12.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/11.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/11.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/10.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/10.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/4.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/4.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/5.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/5.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/7.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/7.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/6.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/6.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/2.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/2.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/3.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/3.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/pose_configurations/schematics/1.png` & `Simba-UW-tf-dev-1.63.1/simba/pose_configurations/schematics/1.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/video_processing.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/video_processing.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/px_to_mm.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/px_to_mm.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/batch_process_menus.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/batch_process_menus.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/multi_cropper.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/multi_cropper.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/extract_frames.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/extract_frames.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/calculate_px_dist.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/calculate_px_dist.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/extract_seqframes.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/extract_seqframes.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/video_processors/batch_process_create_ffmpeg_commands.py` & `Simba-UW-tf-dev-1.63.1/simba/video_processors/batch_process_create_ffmpeg_commands.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/outlier_corrector_movement.py` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/outlier_corrector_movement.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/outlier_corrector_location.py` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/outlier_corrector_location.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/skip_outlier_correction.py` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/skip_outlier_correction.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/.idea/outlier_scripts.iml` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/.idea/outlier_scripts.iml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/.idea/inspectionProfiles/Project_Default.xml` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/.idea/inspectionProfiles/Project_Default.xml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/outlier_tools/.idea/workspace.xml` & `Simba-UW-tf-dev-1.63.1/simba/outlier_tools/.idea/workspace.xml`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/SimBA.py` & `Simba-UW-tf-dev-1.63.1/simba/SimBA.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/unsupervised/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/unsupervised/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/unsupervised/model_names.parquet` & `Simba-UW-tf-dev-1.63.1/simba/assets/unsupervised/model_names.parquet`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/unsupervised/features.csv` & `Simba-UW-tf-dev-1.63.1/simba/assets/unsupervised/features.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/down_arrow.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/down_arrow.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/intruder_shape.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/intruder_shape.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/feature_categories/shap_feature_categories.csv` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/feature_categories/shap_feature_categories.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/resident_shape.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/resident_shape.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/resident_intruder_shape.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/resident_intruder_shape.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/animal_distances.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/animal_distances.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/baseline_scale.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/baseline_scale.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/ubuntu.regular.ttf` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/ubuntu.regular.ttf`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/side_scale.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/side_scale.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/UbuntuMono-Regular.ttf` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/UbuntuMono-Regular.ttf`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/side_scale_5.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/side_scale_5.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/intruder_movement.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/intruder_movement.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/resident_movement.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/resident_movement.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/color_bar.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/color_bar.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/shap/resident_intruder_movement.jpg` & `Simba-UW-tf-dev-1.63.1/simba/assets/shap/resident_intruder_movement.jpg`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/lookups/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/lookups/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/lookups/model_names.parquet` & `Simba-UW-tf-dev-1.63.1/simba/assets/lookups/model_names.parquet`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/lookups/feature_extraction_headers.csv` & `Simba-UW-tf-dev-1.63.1/simba/assets/lookups/feature_extraction_headers.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/lookups/features.csv` & `Simba-UW-tf-dev-1.63.1/simba/assets/lookups/features.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/lookups/unsupervised_example_x.csv` & `Simba-UW-tf-dev-1.63.1/simba/assets/lookups/unsupervised_example_x.csv`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/stl/operant_tray.stl` & `Simba-UW-tf-dev-1.63.1/simba/assets/stl/operant_tray.stl`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/stl/operant_lever.stl` & `Simba-UW-tf-dev-1.63.1/simba/assets/stl/operant_lever.stl`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/stl/operant_walls.stl` & `Simba-UW-tf-dev-1.63.1/simba/assets/stl/operant_walls.stl`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/stl/grid_floor.stl` & `Simba-UW-tf-dev-1.63.1/simba/assets/stl/grid_floor.stl`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/about_me.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/about_me.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/splash.mp4` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/splash.mp4`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/bg_2.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/bg_2.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/splash.pptx` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/splash.pptx`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/img/bg.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/img/bg.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/UbuntuMono-Regular.ttf` & `Simba-UW-tf-dev-1.63.1/simba/assets/UbuntuMono-Regular.ttf`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/factory.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/factory.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/cluster.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/cluster.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/load.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/load.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/gif.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/gif.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/pose.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/pose.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/features.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/features.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/.DS_Store` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/.DS_Store`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/settings.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/settings.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/stopwatch.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/stopwatch.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/link.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/link.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/dash_simba.css` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/dash_simba.css`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/documentation.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/documentation.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/fps.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/fps.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/dimensionality_reduction.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/dimensionality_reduction.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/roi.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/roi.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/superimpose.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/superimpose.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/label.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/label.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/change.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/change.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/crop.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/crop.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/rotate.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/rotate.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/path.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/path.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/clip.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/clip.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/restart.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/restart.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/calipher.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/calipher.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/add_on.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/add_on.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/create.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/create.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/SimBA_logo.ico` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/SimBA_logo.ico`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/print.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/print.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/clf.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/clf.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/concat_icons/mosaic.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/concat_icons/mosaic.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/concat_icons/vertical.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/concat_icons/vertical.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/concat_icons/horizontal.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/concat_icons/horizontal.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/concat_icons/mixed_mosaic.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/concat_icons/mixed_mosaic.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/merge.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/merge.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/clean.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/clean.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/clf_2.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/clf_2.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/visualize.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/visualize.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/concat.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/concat.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/boris.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/boris.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/frames.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/frames.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/video.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/video.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/sample.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/sample.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/metrics.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/metrics.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/grey.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/grey.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/exit.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/exit.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/outlier.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/outlier.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/clahe.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/clahe.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/trash.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/trash.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/about.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/about.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/convert.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/convert.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/SimBA_logo.icns` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/SimBA_logo.icns`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/reorganize.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/reorganize.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/browse.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/browse.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/SimBA_logo.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/SimBA_logo.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/ethovision.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/ethovision.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/icons/close.png` & `Simba-UW-tf-dev-1.63.1/simba/assets/icons/close.png`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/dash_simba_base.css` & `Simba-UW-tf-dev-1.63.1/simba/assets/dash_simba_base.css`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/simba/assets/TheGoldenLab.PNG` & `Simba-UW-tf-dev-1.63.1/simba/assets/TheGoldenLab.PNG`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/Simba_UW_tf_dev.egg-info/PKG-INFO` & `Simba-UW-tf-dev-1.63.1/Simba_UW_tf_dev.egg-info/PKG-INFO`
...
### Comparing `Simba-UW-tf-dev-1.63.0/Simba_UW_tf_dev.egg-info/SOURCES.txt` & `Simba-UW-tf-dev-1.63.1/Simba_UW_tf_dev.egg-info/SOURCES.txt`
...
+simba/plotting/pose_plotter_mp.py
 ...
 simba/pose_configurations/.DS_Store
```

### Comparing `Simba-UW-tf-dev-1.63.0/Simba_UW_tf_dev.egg-info/requires.txt` & `Simba-UW-tf-dev-1.63.1/Simba_UW_tf_dev.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/LICENSE.md` & `Simba-UW-tf-dev-1.63.1/LICENSE.md`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_data_processors.py` & `Simba-UW-tf-dev-1.63.1/tests/test_data_processors.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_distance_plotter.py` & `Simba-UW-tf-dev-1.63.1/tests/test_distance_plotter.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_train_model_mixin.py` & `Simba-UW-tf-dev-1.63.1/tests/test_train_model_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_pose_importers.py` & `Simba-UW-tf-dev-1.63.1/tests/test_pose_importers.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_feature_extraction_mixin.py` & `Simba-UW-tf-dev-1.63.1/tests/test_feature_extraction_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_utils_data.py` & `Simba-UW-tf-dev-1.63.1/tests/test_utils_data.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_config_reader_mixin.py` & `Simba-UW-tf-dev-1.63.1/tests/test_config_reader_mixin.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_outlier_correctors.py` & `Simba-UW-tf-dev-1.63.1/tests/test_outlier_correctors.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_visualize_directing_animals.py` & `Simba-UW-tf-dev-1.63.1/tests/test_visualize_directing_animals.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_featurizers.py` & `Simba-UW-tf-dev-1.63.1/tests/test_featurizers.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_video_processors.py` & `Simba-UW-tf-dev-1.63.1/tests/test_video_processors.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/data/test_projects/zebrafish/feature_file/fish_feature_extraction_092221.py` & `Simba-UW-tf-dev-1.63.1/tests/data/test_projects/zebrafish/feature_file/fish_feature_extraction_092221.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_thirdparty_appenders.py` & `Simba-UW-tf-dev-1.63.1/tests/test_thirdparty_appenders.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_validation_clips.py` & `Simba-UW-tf-dev-1.63.1/tests/test_validation_clips.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/tests/test_roi_tools.py` & `Simba-UW-tf-dev-1.63.1/tests/test_roi_tools.py`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/README.md` & `Simba-UW-tf-dev-1.63.1/README.md`

 * *Files identical despite different names*

### Comparing `Simba-UW-tf-dev-1.63.0/setup.py` & `Simba-UW-tf-dev-1.63.1/setup.py`
